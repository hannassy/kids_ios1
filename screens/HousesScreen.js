...
const HOUSES = [
  {
    ...
    title: "🦁 Гриффиндор",
    color: "#991b1b",
    description: "Смелость, благородство и решимость. Цвета: красный и золотой.",
  },
  {
    key: "hufflepuff",
    title: "🦡 Пуффендуй",
    color: "#92400e",
    description: "Верность, доброта и трудолюбие. Цвета: жёлтый и чёрный.",
  },
  {
    key: "ravenclaw",
    title: "🦅 Когтевран",
    color: "#1e3a8a",
    description: "Интеллект, любознательность и оригинальность. Цвета: синий и серебряный.",
  },
  {
    key: "slytherin",
    title: "🐍 Слизерин",
    color: "#14532d",
    description: "Амбиции, хитрость и воля к победе. Цвета: зелёный и серебряный.",
  },
];
